...
# axes.plot(t103.iloc[:,-3] ,t103.iloc[:,6]/pt[0] , 'k', lw=lw, label="n=11k")
# axes.plot(t104.iloc[:,-3] ,t104.iloc[:,6]/pt[0] , 'k--', lw=lw, label="n=21k")
# axes.plot(t105.iloc[:,-3] ,t105.iloc[:,6]/pt[0] , 'k-.', lw=lw, label="n=38k")
...
# fig2.savefig("jet_nn_euler_t10.pdf")
...
fig3.savefig("jet_nn_euler_t15.pdf")
