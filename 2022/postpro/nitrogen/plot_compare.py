...
t5 = pd.read_csv("t5.csv", ",", skiprows=0)
t10 = pd.read_csv("t10.csv", ",", skiprows=0)
t15 = pd.read_csv("t15.csv", ",", skiprows=0)
t20 = pd.read_csv("t20.csv", ",", skiprows=0)
pt = [4.57e5,4.36e5,3.14e5, 2.33e5]
...
# axes.plot(t10.iloc[:,-3] ,t10.iloc[:,6]/pt[1] , 'k', lw=lw, label="CFD")
...
# fig2.savefig("jet_nn_t10.pdf")

# fig 3
fig3 = plt.figure( dpi=300)
lw = 2
axes = fig3.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(t15.iloc[:,-3] ,t15.iloc[:,6]/pt[2] , 'k', lw=lw, label="CFD")
...
fig3.savefig("jet_nn_t15.pdf")

# # fig 4
# fig4 = plt.figure( dpi=300)
# lw = 2
# axes = fig4.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
# axes.plot(t20.iloc[:,-3] ,t20.iloc[:,6]/pt[3] , 'k', lw=lw, label="CFD")
