...
t7 = pd.read_csv("t7.csv", ",", skiprows=0)
t26 = pd.read_csv("t26.csv", ",", skiprows=0)
...
# axes.plot(t7.iloc[:,-3] ,t7.iloc[:,6]/pt[0] , 'k', lw=lw, label="CFD")
...
# axes.plot(t26.iloc[:,-3] ,t26.iloc[:,6]/pt[1] , 'k', lw=lw, label="CFD")
...
# axes.plot(t49.iloc[:,-3] ,t49.iloc[:,6]/pt[2] , 'k', lw=lw, label="CFD")
...
axes.plot(t82.iloc[:,-3] ,t82.iloc[:,6]/pt[3] , 'k', lw=lw, label="CFD")
