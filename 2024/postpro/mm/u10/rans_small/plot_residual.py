...
t101 = pd.read_csv("history_2.csv", ",", skiprows=0)
...
axes.plot(t101.iloc[:,2] ,t101.iloc[:,3] , color=colors[1], lw=lw, label="level 6")
# axes.plot(t104.iloc[:,2] ,t104.iloc[:,3] , color=colors[4], lw=lw, label="level 4")
# axes.plot(t105.iloc[:,2] ,t105.iloc[:,3] , color=colors[5], lw=lw, label="level 5")
...
fig2.savefig("jet_mm_rans_u10_small_resudial.pdf")
